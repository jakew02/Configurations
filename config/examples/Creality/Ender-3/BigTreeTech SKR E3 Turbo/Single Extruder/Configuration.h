...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE   NEO_GRW // NEO_GRBW / NEO_GRB - four/three channel driver type (defined in Adafruit_NeoPixel.h)
  //#define NEOPIXEL_PIN     4       // LED driving pin
  //#define NEOPIXEL2_TYPE NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN    5
  #define NEOPIXEL_PIXELS 36       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
